    ...
    <div className="space-y-6 max-w-7xl mx-auto p-4 text-gray-800 dark:text-gray-200">
      ...
      <div className="flex flex-col md:flex-row gap-4 p-4 rounded-xl border border-light-border dark:border-dark-border bg-white dark:bg-dark-card shadow-sm text-xs font-semibold">
        <div className="flex-1">
          <input
            ...
            className="w-full px-4 py-2.5 rounded-lg border border-light-border dark:border-dark-border bg-light-hover dark:bg-dark-bg focus:outline-none text-gray-800 dark:text-gray-200"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 md:w-80">
          <select
            ...
            className="px-3 py-2 rounded-lg border border-light-border dark:border-dark-border bg-light-hover dark:bg-dark-bg focus:outline-none text-gray-600 dark:text-gray-300"
          >
                ...
                <tbody className="divide-y divide-light-border dark:divide-dark-border">
                  {questions.map(q => (
                    <tr key={q.id} className="hover:bg-light-hover/10 dark:hover:bg-dark-hover/10">
                      <td className="py-3.5 px-2 max-w-md truncate font-medium text-gray-800 dark:text-gray-200">{q.question}</td>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md bg-white dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl shadow-2xl p-6 relative text-gray-800 dark:text-gray-200">
            <button
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-hover dark:bg-dark-bg focus:outline-none text-gray-600 dark:text-gray-300 font-semibold"
                    required
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-hover dark:bg-dark-bg focus:outline-none text-gray-600 dark:text-gray-300"
                  >
                    <option value="Easy">Easy</option>
                    <option value="Medium">Medium</option>
                    <option value="Hard">Hard</option>
