      ...
      <div className="flex flex-col md:flex-row gap-4 p-4 rounded-xl border border-light-border dark:border-dark-border bg-white dark:bg-dark-card shadow-sm text-xs font-semibold">
        ...
        <div className="md:w-60">
          <select
            ...
            className="w-full px-3 py-2 rounded-lg border border-light-border dark:border-dark-border bg-light-hover dark:bg-dark-bg focus:outline-none text-gray-600 dark:text-gray-300 font-semibold"
          >
              ...
              <tbody className="divide-y divide-light-border dark:divide-dark-border text-[11px] leading-relaxed">
                {logs.map(l => (
                  <tr key={l.id} className="hover:bg-light-hover/10 dark:hover:bg-dark-hover/10">
                    ...
                    <td className="py-2.5 px-2 font-bold text-gray-600 dark:text-gray-300 whitespace-nowrap">{l.user}</td>
                    <td className="py-2.5 px-2 text-gray-600 dark:text-gray-300 max-w-lg truncate" title={l.message}>{l.message}</td>
                  </tr>
                ))}
              </tbody>
            </table>
