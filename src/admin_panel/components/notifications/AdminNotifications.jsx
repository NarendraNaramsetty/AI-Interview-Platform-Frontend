              ...
              {notifications.map(n => (
                <div key={n.id} className="p-4 rounded-lg bg-light-hover/10 dark:bg-dark-bg border border-light-border dark:border-dark-border space-y-2">
                  <div className="flex justify-between items-center text-xs font-semibold">
                    <span className="text-gray-800 dark:text-gray-200 font-bold">{n.title}</span>
                    <span className="text-[10px] text-gray-400">{n.date}</span>
                  </div>
                  <div className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">{n.message}</div>
