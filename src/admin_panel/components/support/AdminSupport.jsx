          ...
          {messages.length > 0 ? (
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-light-border dark:divide-dark-border text-gray-600 dark:text-gray-300">
                  {messages.map(m => (
      ...
      {selectedMessage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md bg-white dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl shadow-2xl p-6 relative text-gray-800 dark:text-gray-200">
            ...
            <div className="p-3 mb-4 rounded-lg bg-light-hover/10 dark:bg-dark-bg border border-light-border dark:border-dark-border text-xs leading-relaxed text-gray-600 dark:text-gray-300">
