          ...
          <div className="p-4 rounded bg-light-hover/10 dark:bg-dark-bg border border-light-border dark:border-dark-border space-y-3 leading-relaxed text-[11px]">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <span className="font-bold text-gray-800 dark:text-gray-200 float-right">15 users</span>
              </div>
              <div>
                <span className="text-gray-400">Mock sessions run:</span>
                <span className="font-bold text-gray-800 dark:text-gray-200 float-right">120 runs</span>
              </div>
              <div>
                <span className="text-gray-400">Evaluations scored:</span>
                <span className="font-bold text-gray-800 dark:text-gray-200 float-right">98 tests</span>
              </div>
              <div>
