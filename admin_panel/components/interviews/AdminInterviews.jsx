              ...
              <tbody className="divide-y divide-light-border dark:divide-dark-border">
                {categories.map((c, i) => (
                  <tr key={c.id} className="hover:bg-light-hover/10 dark:hover:bg-dark-hover/10">
                    ...
                    <td className="py-3.5 px-2 font-bold text-gray-200">{c.name}</td>
                    <td className="py-3.5 px-2 text-gray-300 max-w-sm truncate">{c.description || "No description provided."}</td>
